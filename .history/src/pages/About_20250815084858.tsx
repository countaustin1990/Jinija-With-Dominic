    ...
    >
      ...
      >
        <div>
          <h2 className="text-3xl font-semibold text-primary mb-6">
            Innovating with Passion and Purpose
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            Welcome to Multistream TM Limited, a company dedicated to delivering creative and sustainable solutions. 
            We combine innovative strategies with a commitment to excellence to create products and services that matter.
          </p>
        </div>
      ...
      >
        ...
        <p className="text-primary">
          Our company's journey began with a vision to make a meaningful impact. Every project we undertake reflects 
          our dedication to quality, from initial concept to final delivery.
        </p>
      </motion.div>
          ...
          {[
            {
              ...
              desc: "We provide forward-thinking solutions tailored to your unique needs."
            },
            {
              title: "Client-Centric Approach",
              desc: "Your success is our priority, and we work collaboratively to achieve it."
            },
            {
              title: "Handcrafted Excellence",
              desc: "Our commitment to quality means meticulous attention to every detail."
            }
          ].map((item, index) => (
            <motion.div
              key={index}
      ...
      >
        ...
        <p className="mt-4 text-gray-600 italic">
          "From raw idea to refined artistry—see how we transform concepts into pieces that tell stories."
        </p>
      </motion.div>
