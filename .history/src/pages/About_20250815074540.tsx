...
const AboutUs = () => {
  ...
  const videoUrl = "https://youtu.be/8vveFfMuhKM?si=SB-KkXpt9As4eH3l";
  const videoTitle = "You can partner with us. Join Multistreams TM Ltd";
  ...
  return (
    ...
    >
      ...
      >
        ...
        < className="aspect-video max-w-4xl mx-auto bg-primary rounded-xl overflow-hidden shadow-lg flex items-center justify-center">
          {/* Replace with actual video embed */}
          <YouTubeVideo url="https://youtu.be/8vveFfMuhKM?si=SB-KkXpt9As4eH3l" 
          title={videoTitle} 
           /> 
