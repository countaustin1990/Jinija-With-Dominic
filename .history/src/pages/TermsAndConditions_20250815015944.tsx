    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 mb-4">
          ...
          These Terms govern your use of our website (<a href="https://jinjawithdominic.carrd.co" className="text-amber-700 hover:underline">jinjawithdominic.carrd.co</a>) 
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">2. Custom Orders</h2>
        
        <div className="ml-4 space-y-6">
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">2.1 Process</h3>
          ...
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">2.2 Lead Times</h3>
          ...
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">2.3 Revisions</h3>
            <p className="text-gray-700">
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">3. Payments & Pricing</h2>
        
        <div className="ml-4 space-y-6">
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">3.1 Currency</h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">3.2 Payment Methods</h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">3.3 Pricing Changes</h3>
            <p className="text-gray-700">
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">4. Shipping & Delivery</h2>
        
        <div className="ml-4 space-y-6">
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">4.1 Local Delivery</h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">4.2 Damage in Transit</h3>
            <p className="text-gray-700">
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">5. Returns & Refunds</h2>
        
        <div className="ml-4 space-y-6">
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">5.1 Custom Pieces</h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-xl font-medium text-amber-700 mb-2">5.2 Ready-Made Items</h3>
            <p className="text-gray-700">
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">6. Intellectual Property</h2>
        <p className="text-gray-700">
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">7. Limitation of Liability</h2>
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">8. Governing Law</h2>
        <p className="text-gray-700">
      ...
      <motion.section 
        ...
        className="mb-12"
      >
        <h2 className="text-2xl font-semibold text-amber-800 mb-4">9. Contact</h2>
        <p className="text-gray-700 mb-2">
          For questions:
        </p>
