      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a href="#" className="btn-secondary text-primarygroup text-lg px-12 py-6">
        ...
        <div className="text-center mt-16 animate-scale-in" style={{ animationDelay: '0.6s' }}>
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="btn-secondary bg-secondary/10 hover:bg-secondary/20 text-primary group text-sm md:text-base">
