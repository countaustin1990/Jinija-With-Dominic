...
type HeroProps = {
  ...
  productshowcaseRef: React.RefObject<HTMLDivElement>;
};


export default function Hero ({ scrollToSection, productshowcaseRef }: HeroProps){
  return (
    <section className="relative min-h-screen flex items-center bg-primary overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 md:py-0">
        <div className="max-w-4xl">
          ...
          >
            <a href="https://wa.me/2349030000000" target="_blank" rel="noopener noreferrer">
            <Button onClick={() => scrollToSection(productshowcaseRef)} className="btn-secondary group text-sm md:text-base px-6 py-3">
