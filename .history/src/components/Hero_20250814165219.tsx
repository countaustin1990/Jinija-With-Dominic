...
type HeroProps = { heroImage?: string };
const Hero = ({ heroImage = heroWellness }: HeroProps) =>
 {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-wellness overflow-hidden">
      {/* Background Image with Overlay */}
      <div className="<section className="relative h-[80vh] md:h-[90vh] flex items-center bg-gradient-wellness overflow-hidden">
        <img 
          src={heroWellness} 
