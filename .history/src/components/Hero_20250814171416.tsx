...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-primary/20 via-primary/80 to-transparent overflow-hidden">
      {/* Background Image with Overlay */}
      <div className="relative w-full h-full flex items-center overflow-hidden">
        <img 
          src={heroImage} 
          alt="Natural wellness and herbal health products"
          className="w-[100vw] h-[130vh]  object-fit opacity-30"
        />
      ...
      <div className="relative z-10 container mx-auto section-padding">
        <div className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight animate-slide-up">
            <span className="hero-text text-secondary block">Jinja with Dominic</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-scale-in" style={{ animationDelay: '0.6s' }}>
            ...
            <Button variant="outline" className="border-secondary/30 bg-transparent text-secondary/30 hover:bg-secondary/30 px-8 py-4 rounded-full">
