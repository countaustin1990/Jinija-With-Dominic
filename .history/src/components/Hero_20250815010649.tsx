...
const Hero = ({ scrollToSection, productshowcaseRef }: HeroProps) => {
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 md:py-0">
        <div className="max-w-4xl">
          ...
          >
            ...
            <Button onClick={() => scrollToSection(productshowcaseRef)} className="btn-secondary bg-secondary/10 hover:bg-secondary/20 text-primary group text-sm md:text-base px-6 py-3">
