  ...
  return (
    ...
    >
        <Link to="/">
            <Button
              variant="outline"
              className="border-secondary bg-transparent text-pimary hover:border-primary hover:bg-primary/30 hover:text-primary px-6 py-3 rounded-full text-sm md:text-base"
            >
      ...
      >
        About <span className="text-primary">Multistream TM Limited</span>
      </motion.h1>
      ...
      >
        <div>
          ...
          <p className="text-lg text-gray-700 mb-6">
            Welcome to Multistream TM Limited, your trusted source for high-quality herbal products. 
      ...
      >
        ...
        <p className="text-primary">
          Our company’s journey began with a passion for natural remedies and a vision to make a meaningful impact on people's health. 
          Every product we create reflects our commitment to purity, quality, and efficacy.
        </p>
      </motion.div>
          ...
          {[
            {
              ...
              desc: "We use only the finest natural and ethically sourced ingredients in all our products."
            },
            {
              title: "Sustainable Practices",
              desc: "Our commitment to the environment means we use eco-friendly methods from sourcing to packaging."
            },
            {
              title: "Holistic Wellness",
              desc: "We focus on creating products that support your overall health and well-being naturally."
            }
          ].map((item, index) => (
            <motion.div
              key={index}
      ...
      >
        <h2 className="text-2xl font-semibold text-primary mb-6">Learn About Our Process</h2>
        ...
        <p className="mt-4 text-gray-600 italic">
          "Discover how we harness the power of nature to create products that support a healthier lifestyle."
        </p>
      </motion.div>
      ...
      >
        <h2 className="text-2xl font-semibold text-primary mb-6">Explore Our Products</h2>
        <p className="text-lg text-gray-700 mb-6">
          Ready to start your natural wellness journey? Browse our collection of herbal products.
        </p>
